...
import { fetchMoviesData } from "./webservices/fetchData.js";
import OscarStatsView from "./components/OscarStatsView.jsx";
import TopPerformanceView from "./components/TopPerformanceView.jsx";
import SearchFilterComponent from "./components/SearchFilter.jsx";
import CountryInsightsView from "./components/CountryInsightView.jsx";
    ...
    <div className='App p-0'>
      <div className="w-100 m-0 p-0">
        ...
        <div className="row mx-0 my-2 p-1">
          <div className="col p-2 boxRadius">
            {filteredMovies?.length > 0 ? 
              <CountryInsightsView movies={filteredMovies} />
              :
              <small className="blockTitle">No Record Found</small>
            } 
          </div>    
        </div>
        <div className="row d-flex flex-wrap mx-0 my-2 p-0">
          <div className="col-12 col-md-9 my-0 p-2 ">
            <div className="boxRadius">
              {filteredMovies?.length > 0 ? 
                <OscarStatsView movies={filteredMovies} />
                :
                <small className="blockTitle">No Record Found</small>
              } 
            </div>
          </div>
          <div className="col-12 col-md-3 my-0 p-2">
            <div className="boxRadius">              
              {selectedMovie ? 
                <MovieCard selectedMovie={selectedMovie} /> 
                : 
                <small className="blockTitle">No Record Select</small>
              } 
            </div>
          </div>
        </div>
        <div className="row mx-0 my-2 p-0">
          <div className="col p-2 boxRadius">
            {filteredMovies?.length > 0 ? 
              <TopPerformanceView movies={filteredMovies} />
              : 
              <small className="blockTitle">No Record Found</small>
            } 
          </div>
